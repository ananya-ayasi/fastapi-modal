...
# curl -X POST --get "https://ananya-ayasi--chatterbox-api-example-chatterbox-generate.modal.run" \
#   --data-urlencode "prompt=Chatterbox running on Modal"
#   --output output.wav
# ```
#https://modal.com/apps/ananya-ayasi/main/deployed/chatterbox-api-example
"""
curl -X POST "https://ananya-ayasi--chatterbox-api-example-chatterbox-generate.modal.run?prompt=Chatterbox%20running%20on%20Modal" \
  --output output.wav
"""
#afplay output.wav
